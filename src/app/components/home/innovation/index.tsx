        ...
        <div className="container">
          <div className="flex flex-col gap-12">
            <div className="flex flex-col justify-center items-center gap-10 lg:gap-16">
              <motion.div {...bottomAnimation(1)} className="max-w-(--breakpoint-Xsm) text-center">
                <h2>
                  <span className="font-['Figtree'] dark:text-white/70">Where innovation meets</span>{" "}
                  <span className="instrument-font italic font-normal dark:text-white/70">aesthetics</span>
                </h2>
              </motion.div>
              <motion.div
                {...bottomAnimation(2)}
              ...
              >
                {innovationList?.map((items: any, index: any) => {
                  return (
                    <div key={index} className={`${items.bg_color} flex flex-col p-8 rounded-2xl gap-6 lg:gap-9 `}>
                      <div>
