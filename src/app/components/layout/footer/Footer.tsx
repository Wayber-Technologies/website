    ...
    <footer className="xl:pt-20 pb-6">
      <div className="container">
        <div className="flex flex-col xl:flex-row py-16 gap-10 justify-between border-b border-dark_black/10 dark:border-white/10">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-dark_black/60 dark:text-white/60">{footerData?.contactDetails?.address}</p>
        ...
        <div className="flex justify-center mt-8">
          <p className="text-dark_black/60 dark:text-white/60">{footerData?.copyright}</p>
        </div>
      </div>
    </footer>
  );
