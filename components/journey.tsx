...
import { Marquee, Words } from "@/components";
...
export default function Journey() {
  ...
  return (
    <>
      <Marquee className="text-[#ffeb69]" titile1="Let's build" titile2="good companies" />

      <motion.div
        id="our-ambition"
        className="w-full h-screen xm:h-fit sm:h-fit flex items-center justify-center rounded-[30px] py-10 bg-[#091825] transition-all duration-300 ease-linear mb-20"
