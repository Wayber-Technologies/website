...
import { arrowLeft, arrowRight, collaborationCircle, hartman1, hartmanBlack, saion1, saionBlack } from "@/public";
...
export default function Collaboration() {
  ...
  return (
    <div id="our-impact" className="w-full bg-[#260A2F] py-10 padding-x">
      <div className="w-full flex justify-start items-center xm:pb-10 sm:pb-10">
        <div className="w-[72%] xm:w-full sm:w-full flex flex-col gap-4">
          <h4 className="text-[24px] text-[#FFD7EF] leading-tight tracking-tighter">{t("ourImpactHeading1")}</h4>
      ...
      <div className="w-full py-20 xm:hidden sm:hidden" ref={container}>
        <motion.div style={{ x: sc }} className="w-full flex whitespace-nowrap gap-3">
          {collaborationItems.map((item) => (
            <div
              className="min-w-[500px] flex items-center justify-center py-5 px-5 border-[1.5px] border-[#FFD7EF] rounded-[20px]"
              key={item.id}
            >
              <Image src={item.src} alt="companiesImg" className="w-[600px] h-[100px] object-contain" />
            </div>
          ))}
        </motion.div>
      </div>
      <div className="w-full pb-10 bg-[#9FE870] rounded-[20px]">
        <div className="p-5 overflow-hidden">
          ...
          >
            <SwiperSlide>
              <motion.div className="w-full p-14 xm:p-0 sm:p-0 flex justify-between  rounded-[30px] gap-20 xm:gap-10 sm:gap-10 xm:flex-col sm:flex-col">
                <div className="w-1/2 xm:w-full sm:w-full flex flex-col gap-14 pt-10 xm:gap-5 sm:gap-5">
                  <Image src={hartmanBlack} alt="whatwedoImg" className="w-[100px] object-cover text-black" />
                ...
                <motion.div className="w-1/2 xm:w-full sm:w-full flex items-center justify-center relative">
                  <Image src={hartman1} alt="img" className="w-full object-cover" />
                  <motion.div
                  ...
                  >
                    <Image src={collaborationCircle} alt="heroCircleImg" width={120} height={120} />
                  </motion.div>
                </motion.div>
              </motion.div>
            </SwiperSlide>
            <SwiperSlide>
              <motion.div className="w-full p-14 flex justify-between rounded-[30px] gap-20 xm:gap-10 sm:gap-5 xm:flex-col sm:flex-col xm:p-0 sm:p-0">
                <div className="w-1/2 xm:w-full sm:w-full flex flex-col gap-14 pt-10 xm:gap-5 sm:gap-5">
                  <Image src={saionBlack} alt="whatwedoImg" className="w-[100px] object-cover text-black" />
                  <div className="flex flex-col gap-4">
                    <h4 className="text-[40px] xm:text-[27px] sm:text-[27px] leading-tight tracking-tight">
                      {t("title2")}
                    </h4>
                ...
                <motion.div className="w-1/2 xm:w-full sm:w-full h-full flex items-center justify-center relative">
                  <Image src={saion1} alt="img" className="w-full object-cover" />
                  <motion.div
                    animate={{ rotate: [-360, 360] }}
                    transition={{
                      repeat: Infinity,
          ...
          <div className="flex w-fit gap-2 pl-10 xm:p-0 sm:p-0 xm:pt-5 sm:pt-5">
            ...
            >
              <Image src={arrowLeft} alt="arrowLeft" className="!w-[55px]" width={55} height={55} />
            </div>
            <div
              onClick={handleNext}
              className="bg-[#FFD7EF] hover:bg-[#FFEB69] transition-all duration-200 ease-linear cursor-pointer px-3 py-2 rounded-[30px]"
            >
              <Image src={arrowRight} alt="arrowRight" width={55} height={55} />
            </div>
          </div>
        </div>
      </div>
