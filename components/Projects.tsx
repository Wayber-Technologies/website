...
import { Marquee, ProjectCard, RoundButton, Tags } from "@/components";

export default function Projects() {
  return (
    <section className="w-full rounded-t-[20px] mb-20">
      <Marquee className="text-[#ffeb69]" titile1="Featured Projects" titile2="Featured Projects" />
