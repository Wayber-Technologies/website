  ...
  return (
    <section className="w-full padding-y">
      <div className="w-full flex flex-col">
        <h2 className="sub-heading padding-x font-medium font-aloevera text-secondry pb-[50px]">Compony</h2>
            ...
            <div className="w-1/2 sm:w-full xm:w-full flex justify-between gap-[10px] sm:flex-col xm:flex-col">
              ...
              <div className="flex flex-col gap-y-[10px]">
                <div>
                  ...
                  <p className="paragraph font-aloevera text-secondry">Service Management Software</p>
                </div>
                <div>
                  <p className="paragraph font-aloevera text-secondry underline">Company Size:</p>
                  <p className="paragraph font-aloevera text-secondry">100+ People</p>
                </div>
              </div>
            </div>
          </div>
