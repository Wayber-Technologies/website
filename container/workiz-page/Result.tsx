            ...
            <div className="w-1/2 sm:w-full xm:w-full flex sm:flex-col xm:flex-col gap-[20px]">
              <div className="flex flex-col gap-y-[10px] sm:w-full xm:w-full">
                ...
                <p className="paragraph font-aloevera text-secondry">
                  ...
                  <br className="sm:hidden xm:hidden" />
                  presentation Wayber developed, they were
                  <br className="sm:hidden xm:hidden" />
                  amazed <p className="inline-block sm:hidden xm:hidden">—</p> the final product was exactly
                  <br className="sm:hidden xm:hidden" />
                  what we needed to create a better
                  <br className="sm:hidden xm:hidden" /> experience for new employees and our{" "}
                  <br className="sm:hidden xm:hidden" />
                  clients.”
                </p>
              </div>
