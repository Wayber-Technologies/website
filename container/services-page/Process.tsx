...
export default function Process() {
  const [activeAccordion, setActiveAccordion] = useState(serviceProcessItems[0].id);
  ...
  return (
    <section className="w-full padding-y">
      <div className="w-full padding-x mb-[40px]">
        <h1 className="sub-heading font-medium font-Bricolage text-secondry">Holistic process</h1>
      </div>
        ...
        >
          <div className="w-full flex items-center justify-between py-[10px] padding-x">
            <div className="w-[50%] sm:w-full xm:w-full">
              <h3 className="paragraph font-normal font-Bricolage text-secondry">{item.phase}</h3>
            </div>
            <div className="w-[40%] sm:w-full xm:w-full">
              <h3 className="paragraph font-normal font-Bricolage text-secondry">{item.name}</h3>
            </div>
