...
export default function Projects() {
  ...
  return (
    <div className="w-full" ref={container}>
      <div className="w-full flex flex-col items-center justify-center bg-wayberBlue">
        <div data-scroll data-scroll-speed="-.2" className="bg-[#2629d1] w-[75%] py-[20px] rounded-t-[10px]	" />
        <div
          className="bg-[#2835ef] relative z-20 w-[90%] py-[20px] rounded-t-[10px]"
          data-scroll
          data-scroll-speed="-.1"
        />
      </div>
