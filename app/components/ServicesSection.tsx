...
import { BulbChargingIcon } from '@hugeicons/core-free-icons';
  ...
  const services = [
    {
      ...
      icon: <HugeiconsIcon icon={BulbChargingIcon} className="w-10 h-10 text-purple-500" />,
          ...
          >
            <div className="max-w-4xl text-center">
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800">
                Where innovation <br />meets <span className="italic">aesthetics</span>
              </h2>
            </div>
          </motion.div>
