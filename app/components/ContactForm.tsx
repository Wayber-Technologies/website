        ...
        <div className="flex flex-col gap-10 md:gap-20">
          ...
          >
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-800 mb-6 mt-12">
              Love to hear from you, <br /> Get in <span className="italic font-bold text-gray-600">touch</span>
            </h2>
          </motion.div>
          ...
          {submitted ? (
              ...
              >
                ...
                <Link
                  href="/"
                  className="group w-fit text-white font-medium bg-blue-600 rounded-full flex items-center gap-4 py-3 px-6 hover:bg-blue-700 transition-all duration-200"
                >
              ...
              >
                ...
                <div className="flex flex-col md:flex md:flex-row gap-6">
                  <div className="w-full">
                    <label htmlFor="interest" className="block text-sm font-medium text-gray-700 mb-2">What are you interested in?</label>
                    <select
                      className="w-full rounded-full border border-gray-300 px-5 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-colors"
                      name="interest"
                      id="interest"
                ...
                <div>
                  {!loader ? (
                    <motion.button
                      type="submit"
                      className="group w-fit text-white font-medium bg-blue-600 rounded-full flex items-center gap-4 py-3 px-8 hover:bg-blue-700 transition-all duration-200 shadow-lg hover:shadow-xl"
                    ...
                    <button className="bg-gray-400 flex items-center gap-2 py-3 px-8 rounded-full text-white" disabled>
                      <div className="animate-spin inline-block w-5 h-5 border-2 border-current border-t-transparent rounded-full" role="status">
